...
import com.zenimmersive.android.databinding.AlbumItemBinding
...
class HomeAlbumAdapter (val context: Context, val albumsList: ArrayList<HomeDataResModel.Result.Album?>, val listener: AlbumItemPressListener): RecyclerView.Adapter<HomeAlbumAdapter.ViewHolder>() {
