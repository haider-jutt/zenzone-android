package com.zenimmersive.android.audiomuxer;
...
import com.zenimmersive.android.audiomuxer.input.AudioInput;
...
public class AudioMixer {
    ...
    private void encode(boolean addTrackOnly) {
        while (!mixingDone) {
            ...
            Log.e(TAG, "Encoding Finish Time : " + (System.currentTimeMillis() - exTime) + " Ms");
    ...
    private void muxEncoderOutput() {
        ...
        Log.e(TAG, "Muxing Finish Time : " + (System.currentTimeMillis() - exTime) + " Ms");
    }
