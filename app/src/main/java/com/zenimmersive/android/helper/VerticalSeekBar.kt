...
open class VerticalSeekBar @JvmOverloads constructor(
    ...
    var thumb: FrameLayout? = null
    var barCardView: CardView? = null
    var barBackground: View? = null
    var barProgress: View? = null
    var maxPlaceholder: ImageView? = null
    var minPlaceholder: ImageView? = null
    private fun init(context: Context, attrs: AttributeSet?) {
        var rootView = inflate(context, R.layout.layout_verticalseekbar, this)
        container = rootView.findViewById(R.id.container)
        thumb = rootView.findViewById(R.id.thumb)
        barCardView = rootView.findViewById(R.id.barCardView)
        barBackground = rootView.findViewById(R.id.barBackground)
        barProgress = rootView.findViewById(R.id.barProgress)
        maxPlaceholder = rootView.findViewById(R.id.maxPlaceholder)
        minPlaceholder = rootView.findViewById(R.id.minPlaceholder)
